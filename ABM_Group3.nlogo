...
;    set color red
    ...
    let one number_old + number_single + number_couple + number_family
    set capacity 50000
    set contract 1 / number_rec_companies
    ;set capacity one-of (range (one * 40 / number_rec_companies) (one * 40 / number_rec_companies * 1.1)) ;set random capacity in relation to produce waste and amount of rec facilities
  ]
  set month 0
  reset-ticks
end
